...
import { PortalWorkspaceFileClient } from '../src/main/portal-workspace-file-client';
...
describe('PortalWorkspaceFileClient', () => {
  it('routes workspace file operations through Portal local control', async () => {
  ...
  it('forwards Portal workspace file errors', async () => {
