...
describe("AlphaShell", () => {
  ...
  it("places a tabbed Editor Pane between the Thread and Project Panes after the Project Pane is opened", async () => {
    const value = controller();
    ...
    expect(
      screen.getByRole("separator", {
        name: "Resize Editor and Project Panes",
      }),
    ).toHaveClass(
      "bg-status-bar",
      "before:bottom-[var(--bottom-rail-height)]",
    );
    expect(
      screen.getByRole("separator", {
