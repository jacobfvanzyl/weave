...
export type NativeTerminalBounds = { surfaceId: string; x: number; y: number; width: number; height: number; visible: boolean; readOnly: boolean; focusBorder?: { width: number; radius: number; rgb: number } };
