...
import { builtinDefaultProfile, listResolvedProfiles, type DynamicProfile, type ProfileResolutionInput, type WeaveContextSnapshot } from '../mastra/profiles/resolver';
...
export const profileRoutes = [
  ...
  defineRoute('/agent/profiles/resolved', {
    method: 'GET',
    handler: async c => {
      try {
        return await resolvedResponse(c);
